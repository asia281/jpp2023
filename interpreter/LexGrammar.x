...
resWords =
  b "bool" 25
    ...
    (b "or" 37
       (b "if" 31
          (b "for" 28
             (b "false" 27 (b "else" 26 N N) N)
             (b "fun" 30 (b "from" 29 N N) N))
          (b "len" 34
             (b "int" 33 (b "in" 32 N N) N) (b "not" 36 (b "list" 35 N N) N)))
       (b "to" 43
          (b "return" 40
             (b "push" 39 (b "print" 38 N N) N)
             (b "struct" 42 (b "string" 41 N N) N))
          (b "while" 46
             (b "void" 45 (b "true" 44 N N) N) (b "}" 48 (b "{" 47 N N) N))))
  where
  b s n = B bs (TS bs n)
    where
    bs = s
